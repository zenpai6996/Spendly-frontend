...
const Navbar = ({activeMenu}) => {
  ...
  return (
    ...
    dark:bg-gray-900 border-b dark:border-gray-600 border-primary  py-4 px-6  sticky top-0 z-30'>
      ...
      <h3 className='text-gray-700 text-center hidden md:hidden lg:block pr-170 dark:text-gray-50'> Welcome Back <span className='font-bold text-xl text-primary'> {user?.fullName || "User"} </span> </h3>
